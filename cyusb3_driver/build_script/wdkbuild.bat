...
set STAMPINF_VERSION=1.2.3.16
set STAMPINF_DATE=04/01/2016
...
rem C:\WinDDK\7600.16385.0\tools\Chkinf\chkinf obj%BUILD_ALT_DIR%\%CPU_TYPE%\cyusb3.inf /L cyusb3\%3\%1\chkresult.txt /b
...
rem Enable below  lines to create test sign certificate and add it load machine.
...
rem Signtool sign /v /n "Cypress Semiconductor Technology India Pvt Ltd." /ac "C:\WinDDK\Certificate\MSCV-VSClass3.cer" /t http://timestamp.verisign.com/scripts/timstamp.dll %CD%\cyusb3\%4\%1\cyusb3.sys
rem Signtool sign /v /n "Cypress Semiconductor Technology India Pvt Ltd." /ac "C:\WinDDK\Certificate\MSCV-VSClass3.cer" /t http://timestamp.verisign.com/scripts/timstamp.dll %CD%\cyusb3\%4\%1\cyusb3.cat

rem Signtool sign /v /n "Cypress Semiconductor Corporation" /ac "VeriSign Class 3 Public Primary Certification Authority - G5.cer" /t http://timestamp.verisign.com/scripts/timstamp.dll %CD%\cyusb3\%4\%1\cyusb3.sys
rem Signtool sign /v /n "Cypress Semiconductor Corporation" /ac "VeriSign Class 3 Public Primary Certification Authority - G5.cer" /t http://timestamp.verisign.com/scripts/timstamp.dll %CD%\cyusb3\%4\%1\cyusb3.cat

rem Signtool verify /kp /v /c %CD%\cyusb3\%4\%1\cyusb3.cat %CD%\cyusb3\%4\%1\cyusb3.sys
rem SignTool verify /kp /v /c %CD%\cyusb3\%4\%1\cyusb3.cat %CD%\cyusb3\%4\%1\cyusb3.inf
rem SignTool verify /kp /v %CD%\cyusb3\%4\%1\cyusb3.sys
goto success
